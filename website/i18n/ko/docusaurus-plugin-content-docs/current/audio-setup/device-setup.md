...
> 🖼️ **[IMAGE PLACEHOLDER: Microphone Selection]** *(준비가 되면 이 줄을 다음과 같이 교체하십시오: `![Microphone Setup](/img/audio-mic.png)`)*
...
> 🖼️ **[IMAGE PLACEHOLDER: Loopback Selection]** *(준비가 되면 이 줄을 다음과 같이 교체하십시오: `![Speaker Loopback Setup](/img/audio-speaker.png)`)*
...
> 🖼️ **[IMAGE PLACEHOLDER: Mute Sync Checkbox]** *(준비가 되면 이 줄을 다음과 같이 교체하십시오: `![VRC Mute Sync](/img/audio-mutesync.png)`)*
